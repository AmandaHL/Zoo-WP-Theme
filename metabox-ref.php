...
if ( function_exists( 'add_theme_support' ) ) { 
  ...
  set_post_thumbnail_size( 200, 133, true );
}
 ...
 * @return bool                     True if metabox should show
 */
function bg_hide_if_no_cats( $field ) {
 ...
 */
function bg_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object
 */
function bg_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field object $field      Field object
 */
function bg_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'bg_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function bg_register_demo_metabox() {
	$prefix = 'bg_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'bg_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'bg_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'bg_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'bg_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'bg_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'bg_before_row_if_2', // callback
...
add_action( 'cmb2_admin_init', 'bg_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function bg_register_about_page_metabox() {
	$prefix = 'bg_about_';
...
add_action( 'cmb2_admin_init', 'bg_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function bg_register_repeatable_group_field_metabox() {
	$prefix = 'bg_group_';
...
add_action( 'cmb2_admin_init', 'bg_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function bg_register_user_profile_metabox() {
	$prefix = 'bg_user_';
...
add_action( 'cmb2_admin_init', 'bg_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function bg_register_taxonomy_metabox() {
	$prefix = 'bg_term_';
...
add_action( 'cmb2_admin_init', 'bg_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function bg_register_theme_options_metabox() {

	$option_key = 'bg_theme_options';
